...
function getJSON_data(rows){
    ...
    let data4 =[];
    data4.push(trace4);
    let layout ={margin:{t:10,l:10}};
    let layout2 ={margin: {t: 10,l: 10}};
    let layout3 ={
        margin: {t: 10,l: 10},
        dragmode:"zoom",
        mapbox:{
            style:"open-street-map",
            center:{lat: 23.708167,lon: 120.929999},zoom:5.5
        }

    };
    let layout4 ={margin: {t: 10,l: 10}};
